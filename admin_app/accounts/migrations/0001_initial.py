    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activity_type', models.CharField(max_length=255, verbose_name='Тип активности')),
                ('device', models.CharField(blank=True, max_length=255, null=True, verbose_name='Устройство')),
                ('ip_address', models.GenericIPAddressField(blank=True, null=True, verbose_name='IP Adress')),
